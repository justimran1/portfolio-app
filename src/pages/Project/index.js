      ...
      <div className="parent py-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {items.map((item) => (
              <motion.div
                ...
                key={item.id}
                className="item-container rounded-lg shadow-lg p-3 flex flex-col justify-between hover:shadow-secondary duration-500"
              ...
              >
                <div className="item h-full">
                  ...
                  <div className="overlay">
                    ...
                    >
                      <button className="btn btn-sm border-1 border-transparent bg-secondary hover:bg-transparent text-white hover:border-secondary duration-500">
                        See Details
                      </button>
                    </Link>
                  </div>
        ...
        {location.pathname === "/" && (
          <div className="mt-4 text-right">
            <Link
              to="/project"
              className="text-2xl hover:text-secondary duration-300"
            >
